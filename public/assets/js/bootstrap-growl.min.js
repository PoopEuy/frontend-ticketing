...
(function (e, t, n, r) {
  var i = "growl",
    ...
    o = {
      ...
      icon_type: "class",
      template:
        '<div data-growl="container" className="alert" role="alert"><button type="button" aria-hidden="true" className="close" data-growl="dismiss">&times;</button><span data-growl="icon"></span><span data-growl="title"></span><span data-growl="message"></span><a href="#" data-growl="url"></a></div>',
    };
  var u = function (t, n) {
      o = e.extend(true, {}, o, n);
    },
